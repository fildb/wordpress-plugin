...
grunt.initConfig({
  ...
  copy: {
    main: {
      expand: true,
      src: distFiles,
      dest: "release/filo-data-broker",
    },
  },

  // Task to delete .js.map files
  clean: {
    mapFiles: ["release/filo-data-broker/js/dist/assets/**/*.js.map"],
  },
  ...
  compress: {
    main: {
      options: {
        mode: "zip",
        archive: `./release/filo-data-broker.zip`,
      },
      expand: true,
      src: distFiles,
    ...
    version: {
      options: {
        mode: "zip",
        archive: `./release/filo-data-broker-${pkg.version}.zip`,
      },
      expand: true,
      src: distFiles,
      dest: "/filo-data-broker",
    ...
    todocs: {
      options: {
        mode: "zip",
        archive: `./documentation/public/plugin/filo-data-broker.zip`,
      },
      expand: true,
      src: distFiles,
      dest: "/filo-data-broker",
