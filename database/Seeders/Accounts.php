 ...
 *
 * @package FiloDataBrokerPlugin\Database\Seeders
 * @since 1.0.0
 */
class Accounts {
	...
	public static function run() {
		...
		foreach ( $accounts as $account ) {
			if ( ! \FiloDataBrokerPlugin\Models\Accounts::where( 'user_id', $account['user_id'] )->exists() ) {
				\FiloDataBrokerPlugin\Models\Accounts::create( $account );
			}
		}
	}
}
